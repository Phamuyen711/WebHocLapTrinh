        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            profileForm.addEventListener("submit", (event) => {
                ...
                if (!nameInput.value.trim()) {
                    ...
                    showError(nameInput, "Bắt buộc nhập tên");
                    hasError = true;
                }
                ...
                if (newPassword.value || confirmPassword.value) {
                    ...
                    if (newPassword.value.length < 8) {
                        event.preventDefault();
                        showError(newPassword, "Mật khẩu không được ít hơn 8 kí tự");
                        hasError = true;
                    }

                    if (newPassword.value.length > 150) {
                        event.preventDefault();
                        showError(newPassword, "Mật khẩu không được nhiều hơn 150 kí tự");
                        hasError = true;
                    }
                    ...
                    if (newPassword.value !== confirmPassword.value) {
                        event.preventDefault();
                        showError(confirmPassword, "Mật khẩu không khớp nhau");
                        hasError = true;
                    }
                }
