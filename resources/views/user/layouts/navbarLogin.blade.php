        ...
        <div class="header-wrapper">
            ...
            <div class="user-menu">
                <button id="userMenuBtn" class="user-btn" type="button">
                    ...
                    <span class="user-name">Hey, {{ Auth::user()->displayname }}</span>
                    <i class="fas fa-chevron-down user-dropdown-icon"></i>
                </button>

                <ul id="userDropdown" class="user-dropdown">
                    <li class="user-dropdown-item">
                        <a href="{{ route('user.enrolled-courses') }}" class="user-dropdown-link">Enrolled Courses</a>
                    </li>
                    <li class="user-dropdown-item">
                        <a href="{{ route('user.wishlist.index') }}" class="user-dropdown-link">Wishlist</a>
                    </li>
                    <li class="user-dropdown-divider"></li>
                    <li class="user-dropdown-item">
                        <a href="#" class="user-dropdown-link user-logout"
